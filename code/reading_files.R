...
uk_bank_holidays <- read.csv('uk_bank_holidays.csv',stringsAsFactors = F,sep = ',')
uk_bank_holidays$is_holiday <- 1
uk_bank_holidays <- select(uk_bank_holidays,c(1,3))
colnames(uk_bank_holidays) <- c('date','is_holiday')

weather_daily_darksky <- read.csv('weather_daily_darksky.csv',stringsAsFactors = F,sep = ',')
...
weather_hourly_darksky <- read.csv('weather_hourly_darksky.csv',stringsAsFactors = F,sep = ',')
...
informations_households <- read.csv('informations_households.csv',stringsAsFactors = F,sep = ',')
